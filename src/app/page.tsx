...
export default function About() {
  const structure = [
    ...
    },
    {
      ...
      items: about.certs.certsList.map((experience) => experience.name),
    },
    {
    ...
    <Column maxWidth="m">
      ...
      <Flex fillWidth mobileDirection="column" horizontal="center">
        ...
        <Column className={styles.blockAlign} flex={9} maxWidth={40}>
          ...
          {about.certs.display && (
            <>
              <Heading as="h2" id={about.certs.title} variant="display-strong-s" marginBottom="m">
                {about.certs.title}
              </Heading>
              <Column fillWidth gap="l" marginBottom="40">
                {about.certs.certsList.map((cert, index) => (
